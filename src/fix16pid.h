...
#define PID_KP 	F16(0.3)
#define PID_KI	F16(0.3)
#define PID_KD	F16(0.100)
#define PID_TAU	F16(1.0)
#define PID_LIM_MIN F16C(0,0) 
#define PID_LIM_MAX F16C(3299,0)
#define PID_LIM_MIN_INT F16C(-1600,0)
#define PID_LIM_MAX_INT	F16C(1600,0)	
#define SAMPLE_TIME_S F16(0.0014) //ADC timer period
